"""
Geração de template LaTeX (estrutura IEEE/ACM) — Teste de Mutação
Execute: python scripts/gerar_latex.py
Saída:   reports/relatorio_mutacao.tex
"""

import os

OUT_DIR  = os.path.join(os.path.dirname(__file__), '..', 'reports')
OUT_FILE = os.path.join(OUT_DIR, 'relatorio_mutacao.tex')
os.makedirs(OUT_DIR, exist_ok=True)

# Caminhos relativos das imagens (ajuste se necessário)
IMG = {
    'score':    'graficos/01_mutation_score.png',
    'cobertura':'graficos/02_cobertura.png',
    'ini':      'graficos/03_mutantes_inicial.png',
    'fin':      'graficos/04_mutantes_final.png',
    'painel':   'graficos/05_painel_comparativo.png',
}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{""" + IMG['cobertura'] + r"""}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\columnwidth]{""" + IMG['ini'] + r"""}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{""" + IMG['score'] + r"""}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{""" + IMG['painel'] + r"""}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\columnwidth]{""" + IMG['fin'] + r"""}
...
print(f'✔ LaTeX gerado: {os.path.abspath(OUT_FILE)}')
print()
print('Para compilar:')
print('  pdflatex reports/relatorio_mutacao.tex')
print('  pdflatex reports/relatorio_mutacao.tex  (segunda passagem p/ refs)')
print()
print('Ou use Overleaf: arraste o .tex e a pasta graficos/ para um projeto novo.')
